...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (this.removeClass.length)
            this.container.find('.removeBtn').addClass(this.removeClass);
        this.container.find('.applyBtn').html(this.locale.applyLabel);
        this.container.find('.cancelBtn').html(this.locale.cancelLabel);
        this.container.find('.removeBtn').html(this.locale.removeLabel);
        //event listeners
        ...
        this.container.find('.ranges')
            ...
            .on('click.daterangepicker', 'button.removeBtn', $.proxy(this.clickRemove, this))
    ...
    DateRangePicker.prototype = {
        ...
        clickRemove: function (e) {
          ...
          this.element.find("input[name*='start']").val("");
          this.element.find("input[name*='end']").val("");
          this.element.find("input[name*='Start']").val("");
          this.element.find("input[name*='End']").val("");
          this.hide();
        },
